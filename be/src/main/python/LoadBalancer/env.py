...
HAPROXY_SOCKET_ADDRESS = os.environ.get('HAPROXY_SOCKET_ADDRESS') if os.environ.get('HAPROXY_SOCKET_ADDRESS') is not None else "/Users/aidan/run/haproxy/haproxy.sock"
...
HAPROXY_FRONTEND_PORT = int(os.environ.get('HAPROXY_FRONTEND_PORT')) if os.environ.get('HAPROXY_FRONTEND_PORT') is not None else 6666
